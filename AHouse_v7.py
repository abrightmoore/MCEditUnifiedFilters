...
inputs = (
		...
		("Operation", (
			...
			"House (Steps)",
			"Neighbourhood - copy",
			"Neighbourhood - square 1",
			"Neighbourhood - square 2",
			"Neighbourhood - square 3",
			"Neighbourhood - square 4",
			"Neighbourhood - pack",
			"Fill Air",
			"Fill Air from MAX",
			...
			"Neighbourhood - row",
			"Neighbourhood - row of schematics",
			"Neighbourhood - col",
			"Neighbourhood - col of schematics",
			"Neighbourhood - pack",
			"Neighbourhood - pack schematics"

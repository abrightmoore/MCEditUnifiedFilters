...
def spaceShip1(level0,box0,options):
	...
	DV = 0.5*QUANTUM*RAND.randint(1,4)
	for i in xrange(0,SEGMENTS+1):
		dY = int(centreHeight/DV)
...
#	return
	...
	LENGTH = depth
	LQD = RAND.randint(5,10)
	LENGTHQUANTUM = depth/LQD
	WIDTH = width
	WQD = RAND.randint(5,12)
	WIDTHQUANTUM = width/WQD
	HEIGHT = height
	HQD = RAND.randint(4,8)
	HEIGHTQUANTUM = height/HQD

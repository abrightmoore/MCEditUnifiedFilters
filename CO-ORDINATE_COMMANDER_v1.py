# This filter creates Command Blocks with iterated values passed in to the commands
...
inputs = (
	  ("CO-ORDINATE COMMANDER", "label"),
	  ("Pre-text:", ("string","value=summon Chicken ")),
	  ("X Base", 1),
	  ("X Step Size", 1),
	  ("X Base", 1),
	  ("Y Step Size", 1),
	  ("X Base", 1),
	  ("Z Step Size", 1),
	  ("Post-text:", ("string","value= {Riding:{id:Bat},CustomName:DUCKULA!}")),
